...
model = AutoModel.from_pretrained("google/mt5-small", token="hf_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
tokenizer = AutoTokenizer.from_pretrained("google/mt5-small", token="hf_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
...
class DataTrainingArguments:
    ...
    wandb_project_id: Optional[str] = field(
        default=None,
        metadata={"help": "Weights & Biases project ID for experiment tracking."},
    )
